<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div>
                <a href="{{ route('internship.show', $application->internship) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-800">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Employer View -->
            @if(auth()->user()->isEmployer() && $application->internship->employer_id == auth()->user()->employer->id || auth()->user()->isAdmin())
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mt-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('applications.index', ['internship_id' => $application->internship_id]) }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 transition-colors duration-200 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
